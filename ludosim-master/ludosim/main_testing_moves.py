...
if __name__ == '__main__':
    ...
    print players[0].number_of_sound_moves
    print players[0].number_of_moves
    print players[0].number_of_sound_moves/float(players[0].number_of_moves)
    ...
    players = [ MariusPlayer(0, '../../n_marius_for_testing_simple'),
                ludosim.RandomPlayer(1, 'Random player 1'),                
                ludosim.RandomPlayer(2, 'Random player 2'),
                ludosim.RandomPlayer(3, 'Random player 3') ]        
#
